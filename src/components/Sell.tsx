        ...
        <Col xs={6} md={4}>
          ...
          <Form onSubmit={handleSumbit}>
            <Form.Group controlId="formFileMultiple" className="mb-3">
              ...
              <Form.Control className="input" type="file" multiple onChange={handleIamgeChange} accept='image/*'  />
            </Form.Group>
            ...
            <Row>
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control as="select" name="category" value={sellCategory} className="input" onChange={handleChange}>
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control as="select" name="size" value={sellSize} className="input" onChange={handleChange}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="price" value={sellPrice} className="input" placeholder="Cost?" onChange={handleChange} />
            </Form.Group>
